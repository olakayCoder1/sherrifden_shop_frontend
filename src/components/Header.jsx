            ...
            <nav className=" bg-white antialiased border-b-1">
                ...
                {/* <div className="max-w-screen-xl px-4 mx-auto 2xl:px-0 p-4"> */}
                    ...
                    <ul className="text-gray-900  text-sm font-medium dark:text-white space-y-3">
                        ...
                        <li>
                        <Link to={'/products'} className="hover:text-primary-700 dark:hover:text-primary-500">Products</Link>
                        </li>
                        <li>
                        <Link to={'/'} className="hover:text-primary-700 dark:hover:text-primary-500">Contact</Link>
                        </li>
                    </ul>
                    </div>
                </div>
